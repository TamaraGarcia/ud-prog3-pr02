...
public class Coche {
	...
	//Constantes:
	protected final static double MASA = 1;
	protected final static double  FUERZA_BASE_ADELANTE = 2000;
	protected final static double  FUERZA_BASE_ATRAS = 1000;
	protected final static double  COEF_RZTO_SUELO = 15.5;
	protected final static double  COEF_RZTO_AIRE = 0.35;
	...
	*/
	...
	public double fuerzaAceleracionAtras() {
		if (miVelocidad<=-350) 
			return FUERZA_BASE_ATRAS * ((miVelocidad/150) + 500/150);
		else if (miVelocidad<=-200) 
			return FUERZA_BASE_ATRAS;
		else if (miVelocidad<=0)
			return FUERZA_BASE_ATRAS * ((miVelocidad*-0.0035) + 0.3);
		else if (miVelocidad<=250) 
			return FUERZA_BASE_ATRAS * ((miVelocidad*0.0022) + 0.3);
		else 
